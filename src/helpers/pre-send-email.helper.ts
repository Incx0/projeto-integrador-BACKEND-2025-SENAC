...
export async function sendRecupCodeEmail(
    //tipações dos paramêtros
    email:string, 
    nome:string, 
    recupCode: string
){  
    //envia o email de recueperação
    await sendMail(
        email,
        //html do email a ser enviado
        "Recuperação de senha",
        `Olá, foi requisitado a alteração de senha para o usuário linkado a este email!`,
        `
        <!DOCTYPE html>
        <html lang="pt-BR">
        <head>
